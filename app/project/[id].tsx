  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        {project.isDone && <Ionicons name="checkmark-circle" size={24} color={colors.success} />}
      </View>
      ...
      <View style={styles.progressSection}>
        ...
        <View style={[styles.progressBar, { backgroundColor: colors.border }]}>
          <Animated.View
            style={[styles.progressFill, { backgroundColor: accentColor, width: `${progress * 100}%` as any }]}
          />
        </View>
        <View style={styles.dateMeta}>
          <Ionicons name="calendar-outline" size={12} color={colors.mutedForeground} />
          <Text style={[styles.dateText, { color: colors.mutedForeground }]}>Started {project.startDate}</Text>
        </View>
      </View>
      ...
      {!project.isDone && <FloatingButton onPress={() => setShowAdd(true)} bottom={0} />}
      ...
      <Modal transparent animationType="slide" visible={showAdd} onRequestClose={() => setShowAdd(false)}>
        <View style={styles.modalOverlay}>
          <Animated.View
            ...
            style={[
              styles.modalSheet,
              { backgroundColor: colors.card, paddingBottom: insets.bottom + 20, borderTopLeftRadius: 24, borderTopRightRadius: 24 },
            ]}
          >
            ...
            <View style={styles.modalBody}>
              ...
              <View style={styles.pickerRow}>
                <View style={{ flex: 1 }}>
                  <DatePicker value={taskDate} onChange={setTaskDate} placeholder="Pick date" />
                </View>
                <View style={{ flex: 1 }}>
                  <TimePicker value={taskTime} onChange={setTaskTime} placeholder="Pick time" dateContext={taskDate} />
                </View>
              </View>
              <TouchableOpacity
                style={[
                  styles.saveBtn,
                  { backgroundColor: taskTitle.trim() ? accentColor : colors.border, borderRadius: colors.radius },
                ]}
      ...
      {/* Edit Task Modal */}
      <Modal transparent animationType="slide" visible={!!editTask} onRequestClose={() => setEditTask(null)}>
        <View style={styles.modalOverlay}>
          <Animated.View
            entering={FadeInDown.duration(300).springify()}
            style={[
          ...
          >
            ...
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setEditTask(null)} hitSlop={12}>
                <Ionicons name="close" size={24} color={colors.mutedForeground} />
              </TouchableOpacity>
            </View>
            <View style={styles.modalBody}>
              ...
              <View style={styles.pickerRow}>
                ...
                <View style={{ flex: 1 }}>
                  <TimePicker value={editTime} onChange={setEditTime} placeholder="Pick time" dateContext={editDate} />
                </View>
              </View>
              <TouchableOpacity
                style={[
                  styles.saveBtn,
                  { backgroundColor: editTitle.trim() ? accentColor : colors.border, borderRadius: colors.radius },
                ]}
