    ...
    <Animated.View style={[styles.item, { transform: [{ scale }] }]}>
      <View style={styles.left}>
        <TouchableOpacity
          ...
          style={[styles.node, { backgroundColor: nodeColor, borderColor: nodeColor }]}
        >
  ...
  if (sorted.length === 0) {
    return (
      <View style={styles.empty}>
        ...
        <Text style={[styles.emptyText, { color: colors.mutedForeground }]}>No tasks yet. Add one below.</Text>
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  node: { width: 24, height: 24, borderRadius: 12, borderWidth: 2, alignItems: "center", justifyContent: "center", zIndex: 1 },
  line: { width: 2, flex: 1, minHeight: 20, marginTop: 2, marginBottom: -4 },
